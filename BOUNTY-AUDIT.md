...
- **ENS:** PARTIAL — resolution + ENSIP-26 records + worker discovery work live on Sepolia, but the ENSIP-25 `verify` claim does not currently pass and worker reputation pointers point at the wrong registry. Fix the attestation record + pointers, or soften the "ENSIP-25 verified" wording.
